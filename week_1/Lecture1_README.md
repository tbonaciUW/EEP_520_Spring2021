...
Resources
---
- **Canvas**: https://canvas.uw.edu/courses/1466673
- **Github**
    - Course repo: https://github.com/tbonaciUW/EEP_520_Spring2021
...
```bash
git clone https://github.com/tbonaciUW/EEP_520_Spring2021
...
The Github repo for `EEP_520_Spring2021` is managed by Dr. Bonaci. The Github repo for `520-Assignments` is managed by you.
